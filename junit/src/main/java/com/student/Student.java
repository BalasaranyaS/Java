...
public class Student {
    ...
    public Student(int studentId, String studentName, String city, int marks1, int marks2, int marks3, float feePerMonth,boolean isEligibleForScholarship) {
        ...
        this.isEligibleForScholarship = isEligibleForScholarship; // Default value
    }
    ...
    public static void main(String[] args) {
        ...
        Student student1 = new Student(1, "Alice", "New York", 70, 80, 90, 5000,false);
        Student student2 = new Student(2, "Bob", "Los Angeles", 65, 75, 55, 4500,true);
        Student student3 = new Student(3, "Charlie", "Chicago", 80, 75, 60, 4800,true);
    ...
    public static Student getStudentWithHighestTotalMarks(Student[] students) {
        ...
        for (Student student : students) {
            if (student.marks1 > 60 && student.marks2 > 60 && student.marks3 > 60){
    ...
    public static void displayDetails(Student[] students) {
        for (Student student : students) {
            String details = (student.getStudentName() + student.getTotalMarks() + student.getResult() + student.isEligibleForScholarship());
